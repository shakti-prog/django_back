...
This repository is a part of a recommendation system created for an ecommerce website. The website uses collaborative filtering for the recommendations. The algorithm used is Matrix Factorization. 

This repo has the django code that was used for implementing the machine learning model used for recommending ecommerce products. The model was implemented using matrix factorization.
